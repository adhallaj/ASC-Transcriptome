...
indir="/home/aubaxh001/blastx/latestresults" # directory containing your BLAST output table, just get rid of the text within the quotes and fill in your appropriate directory
blastfile="A1_blastedmaster" # the name of your output table from BLAST, change for each BLAST output
goinfo="/home/aubaxh001/blastx/GOfiles/masterGO.csv" # the name of a file containing genes and GO term info from your organism that you BLASTed against. We can get this from ENSEMBL, I will show you
mincoverage="26" # how much of the "query" sequence you want to be covered by the "match" sequence. This is the value you have to multiply by 3 to get the actual percentage.
...
do
	...
	grep "$EI" $goinfo | sed -r "s/^ENS/$TRINITY,$PID,$EVAL,$BIT,$COV,ENS/g" >> annotation_table.csv
done
...
seqkit grep -v -f annotated_transcripts.txt /home/aubaxh001/cdhit/A1_rmdup -o unannotated_contigs.fa
